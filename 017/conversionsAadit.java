...
public class conversionsAadit {
    ...
    static void decimalFunction(String choice){
        ...
        System.out.println(Integer.toBinaryString(c)+"binary");
        System.out.println(Integer.toHexString(c)+"hex");
        System.out.println(Integer.toOctalString(c)+"octal");
        again();
    }
    // function for the choice being 2 
    static void binaryFunction(String choice){     
        System.out.println(Integer.parseInt(choice,2)+"decimal");
